<%-- 
    ...
    Created on : 24 de out de 2021, 22:05:12
    Author     : Felype
--%>
...
<html>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h3>Relatório de Vendas por Filial</h3>
                            </div>
                            <div class="card-body">
                                <form class="row g-3">
                                    <h4>Selecione o Período</h4>
                                    <div class="col-sm-2 position-relative">
                                        <label for="peridoRelFilialDe" class="form-label">De:</label>
                                        <input type="text" class="form-control" name="peridoRelFilialDe" id="peridoRelFilialDe" required">
                                    </div>
                                    <div class="col-sm-2 position-relative">
                                        <label for="peridoRelFilialAte" class="form-label">Até:</label>
                                        <input type="text" class="form-control" name="peridoRelFilialAte" id="peridoRelFilialAte" required">
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                <div id="chart-vendas-filiais"></div>
                                            </div>
                                        </div>
                                    </div>
                                </form>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $('#peridoRelFilialDe').mask('00/00/0000');
            $('#peridoRelFilialAte').mask('00/00/0000');
        });
        $(document).ready(function () {
            setTimeout(function () {
                $(function () {
                    ...
                    var chart = new ApexCharts(
                            document.querySelector("#chart-vendas-filiais"),
                            options
                            );
                    chart.render();
                });
